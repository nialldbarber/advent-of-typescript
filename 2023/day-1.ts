 ...
 * - chocolate-chip
 *
 * But the elves have some kind of fancy code-gen build step (built in
 * Rust, of course), so all Santa needs to do is update the
 * `SantasFavoriteCookies` type to accept either of his favorite cookies.
 */

// Challenge
// Starting point: type SantasFavoriteCookies = unknown;
